...
export default async function SharedLookbookPage({ params }: Props) {
  ...
  const brandColor = lookbook.stylist.brand_color || "#0f766e";
  const stylistName =
  ...
  return (
    <main className="min-h-screen bg-stone-50">
            ...
            {lookbook.items.map((item) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {item.note && (
                    <p className="mt-3 rounded-lg bg-stone-50 px-3 py-2 text-sm italic text-stone-700">
      ...
      <footer className="pb-10 text-center text-xs text-stone-400">
        Shared privately by {stylistName} · Powered by Hueline
      </footer>
    </main>
  );
}
